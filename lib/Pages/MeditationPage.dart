...
import 'DirectionMedScreenPage.dart';
...
class _MeditationPageState extends State<MeditationPageState> {
        ...
        children: [
          ...
          if (_showOverlayMedDirection)
            Positioned(
              ...
              bottom: 0,
              child: GestureDetector(
                onTap: _hideDirectionMedScreenPage,
                child: Container(
                  color: Colors.black.withOpacity(0),
                ),
              ),
          ...
          if (_showOverlayMedDirection)
            Positioned(
              ...
              right: 0,
              bottom: 340,
              child: DirectionMedScreenPageState(),
            ),
          Positioned(
            bottom: 0,
            width: 390,
  ...
  bool _showOverlayMedDirection = false;
  ...
  void _showDirectionMedScreenPage() {
    setState(() {
      _showOverlayMedDirection = true;
    });
  }

  void _hideDirectionMedScreenPage() {
    setState(() {
      _showOverlayMedDirection = false;
    });
  }
  ...
  List<Video> getVideoList() {
    final file =
    File('/Users/aliya/StudioProjects/mental_health_new/meditation.json');
    ...
    if(sortedMedDirection != "любое направление"){
      videosList.removeWhere((video) {
        return video.workout_type != sortedMedDirection;
      });
    }
